    ...
    var spawnWorker = () => {
      ...
      worker.on('message', function (msg) {
        ...
        if (msg.counter) {
          ...
          process.stdout.write(clc.black.bgYellowBright(`Archives Collections Agent Serialization: ${Math.floor(totalDone / totalTodo * 100)}% ${++totalDone} Agents: ${totalAgentsAdded} Bots:${totalBots}`))
        }
        if (msg.counterAdded) {
