    ...
    if (viaf) {
      ...
      if (viaf.lcTerm) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          ...
          newAgent.altForms.push({name: viaf.lcTerm, type: 'viaf.lcTerm', source: 'shadowcat', id: source})
        }
      }
      if (viaf.viafTerm) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: viaf.viafTerm, type: 'viaf.viafTerm', source: 'shadowcat', id: source})
        }
      }
      if (scAgent.nameLocal) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: viaf.nameLocal, type: 'viaf.nameLocal', source: 'shadowcat', id: source})
        }
      }
      ...
      if (scAgent.nameLc) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: scAgent.nameLc, type: 'scAgent.nameLc', source: 'shadowcat', id: source})
        }
      }
      if (scAgent.nameViaf) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: scAgent.nameViaf, type: 'scAgent.nameViaf', source: 'shadowcat', id: source})
        }
      }
      if (scAgent.nameLocal) {
        normal = normalize.normalizeAndDiacritics(scAgent.nameLocal).trim()
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: scAgent.nameLocal, type: 'scAgent.nameLocal', source: 'shadowcat', id: source})
        }
      }
    ...
    if (!registryAgent.viaf && viaf) {
      ...
      if (viaf.lcTerm) {
        ...
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          ...
          registryAgent.altForms.push({name: viaf.lcTerm, type: 'viaf.lcTerm', source: 'shadowcat', id: source})
        }
      }
      if (viaf.viafTerm) {
        normal = normalize.normalizeAndDiacritics(viaf.viafTerm).trim()
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: viaf.viafTerm, type: 'viaf.viafTerm', source: 'shadowcat', id: source})
        }
      }
      if (scAgent.nameLocal) {
        normal = normalize.normalizeAndDiacritics(scAgent.nameLocal).trim()
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: viaf.nameLocal, type: 'viaf.nameLocal', source: 'shadowcat', id: source})
        }
      }
      ...
      if (scAgent.nameLocal) {
        ...
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: scAgent.nameLocal, type: 'scAgent.nameLocal', source: 'shadowcat', id: source})
        }
      }
