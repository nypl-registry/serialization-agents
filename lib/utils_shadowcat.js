...
/**
* Lookup all sc:agents in existing agents collection by their supplied viaf
*
* @param  {array} agents - Array of 'sc:agents'
* @param  {function} cb - callback
* @return {obj} viaf data -
...
/**
* Lookup all sc:agents in existing agents collection by normalized name
*
* @param  {array} agents - Array of 'sc:agents'
* @param  {function} cb - callback
* @return {obj} viaf data -
*/
exports.lookupShadowcatAgentsInRegistryAgentsByName = (bib, cb) => {
  // builds a lookup of all the agents so we can save time if there are the same agent twice (contributor and subject for example)
  var lookup = {}
  ...
  _(bib['sc:agents'])
    .map((agent) => {
      // take the viaf ID out of the viaf data and pass it on to the lookup
      if (lookup[agent.nameLocal]) return ''
      return agent.nameLocal
    })
    .compact()
    ...
    .done(() => {
      // backfill in the data
      bib['sc:agents'] = bib['sc:agents'].map((agent) => {
        agent.agent = lookup[agent.nameLocal]
        return agent
      })
      if (cb) cb(null, bib)
    })
...
* @return {obj} viaf data -
*/
exports.updateShadowcatAgentsByName = (agents, cb) => {
  _(agents)
  ...
  if (scAgent && !registryAgent) {
    ...
    if (viaf) {
      ...
      if (!newAgent.nameControlled) {
        console.log('-------no name controlled-------')
      ...
      if (viaf.lcTerm) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          ...
          newAgent.altForms.push({name: viaf.lcTerm, type: 'viaf.lcTerm', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, viaf.lcTerm), fuzzy: newAgent.nameControlled.score(viaf.lcTerm, 0.5)})
        }
      }
      if (viaf.viafTerm) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: viaf.viafTerm, type: 'viaf.viafTerm', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, viaf.viafTerm), fuzzy: newAgent.nameControlled.score(viaf.viafTerm, 0.5)})
        }
      }
      if (scAgent.nameLocal) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          ...
          newAgent.altForms.push({name: scAgent.nameLocal, type: 'scAgent.nameLocal', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, scAgent.nameLocal), fuzzy: newAgent.nameControlled.score(scAgent.nameLocal, 0.5)})
        }
      }
      ...
      if (scAgent.nameLc) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: scAgent.nameLc, type: 'scAgent.nameLc', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, scAgent.nameLc), fuzzy: newAgent.nameControlled.score(scAgent.nameLc, 0.5)})
        }
      }
      if (scAgent.nameViaf) {
        ...
        if (newAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          newAgent.nameNormalized.push(normal)
          newAgent.altForms.push({name: scAgent.nameViaf, type: 'scAgent.nameViaf', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, scAgent.nameViaf), fuzzy: newAgent.nameControlled.score(scAgent.nameViaf, 0.5)})
        }
      }
      if (scAgent.nameLocal) {
        normal = normalize.normalizeAndDiacritics(scAgent.nameLocal).trim()
    ...
    if (!registryAgent.viaf && viaf) {
      ...
      if (viaf.lcTerm) {
        ...
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          ...
          registryAgent.altForms.push({name: viaf.lcTerm, type: 'viaf.lcTerm', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, viaf.lcTerm), fuzzy: newAgent.nameControlled.score(viaf.lcTerm, 0.5)})
        }
      }
      if (viaf.viafTerm) {
        normal = normalize.normalizeAndDiacritics(viaf.viafTerm).trim()
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: viaf.viafTerm, type: 'viaf.viafTerm', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, viaf.viafTerm), fuzzy: newAgent.nameControlled.score(viaf.viafTerm, 0.5)})
        }
      }
      if (scAgent.nameLocal) {
        normal = normalize.normalizeAndDiacritics(scAgent.nameLocal).trim()
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: viaf.nameLocal, type: 'viaf.nameLocal', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(newAgent.nameControlled, scAgent.nameLocal), fuzzy: newAgent.nameControlled.score(scAgent.nameLocal, 0.5)})
        }
      }
      ...
      if (scAgent.nameLocal) {
        ...
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: scAgent.nameLocal, type: 'scAgent.nameLocal', source: 'shadowcat', id: source.id, poverlap: normalize.percentOverlap(registryAgent.nameControlled, scAgent.nameLocal), fuzzy: registryAgent.nameControlled.score(scAgent.nameLocal, 0.5)})
        }
      }
      ...
      if (scAgent.nameLocal) {
        ...
        if (registryAgent.nameNormalized.indexOf(normal) === -1 && normal !== '') {
          registryAgent.nameNormalized.push(normal)
          registryAgent.altForms.push({name: scAgent.nameLocal, type: 'scAgent.nameLocal', source: 'shadowcat', id: source.id, poverlap: 100, fuzzy: 1})
        }
      }
